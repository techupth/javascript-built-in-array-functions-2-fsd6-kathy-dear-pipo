...
// ให้เขียนโปรแกรมที่สามารถนับจำนวนสมาชิกทั้งหมด โดยจะไม่นับชื่อที่ซ้ำกัน โดยใช้ Built-in Array Function --> indexOf
...
const uniqueMembers = billMembers.filter(
  (item, index) => billMembers.indexOf(item) === index
);
...
//   'Bank',    'P'
// ]
console.log(`Unique Members Count: ${uniqueMembers.length}`);
